...
public :
	...
	inline int32_t minK(void) const { return _minK ; }
	inline int32_t maxK(void) const { return _maxK ; }
	inline double avgK(void) const { return _avgK ; }
	...
	inline void SetValue(int32_t IDX, int32_t v) { _Value[IDX] = v ; }
...
protected :
	int32_t _VarOrdering_InducedWidth ; // width of the ordering = MaxCliqueSize-1
...
public :
	...
	inline void AddQueryVariable(int32_t v)
	{
		_QueryVariables.push_back(v) ;
	}
